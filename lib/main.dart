...
import 'notification_services/notification_services.dart' as notification_services;
...
void main() async {
  ...
  try {
    ...
    FirebaseMessaging.onBackgroundMessage(notification_services.firebaseMessageBackgroundHandle);
